...
export async function updateHorizontalResult(resultId, first, second, third, fourth, fifth, sixth, performance, place) {
    const result = await ResultModel.findById(resultId).exec();
    if (result != null) {
        result.performance = performance;
        if (place !== "") {
...
export async function updateVerticalResult(resultId, first, second, third, fourth, fifth, sixth, performance, place) {
    const result = await ResultModel.findById(resultId).exec();
    if (result != null) {
        result.performance = performance;
        if (place !== "") {
